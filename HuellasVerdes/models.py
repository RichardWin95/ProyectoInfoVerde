...
class BasOficiona(db.Model):
    ...
    ofi_reserva_anual=db.Column(db.Float)
...
class TrnDetalleMuestra(db.Model):
    ...
    det_tmpo_uso = db.Column(db.Float) #ofi_reserva_anual*cantidad
    det_tmpo_fntsma = db.Column(db.Float)
...
class BasFactorEmision(db.Model):
    ...
    fac_resolucion = db.Column(db.String(50), nullable=False)
...
class BasMuestra(db.Model):
    ...
    mue_dscrpcion = db.Column(db.String(40), nullable=False)
...
class BasResponsable(db.Model):
    ...
    res_nombre = db.Column(db.String(30), nullable=False)
    res_apellido = db.Column(db.String(30), nullable=False)
...
class BasCargo(db.Model):
    ...
    car_dscrpcion = db.Column(db.String(30), nullable=False)
